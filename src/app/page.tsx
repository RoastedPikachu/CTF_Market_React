...
export default function Home() {
  ...
  const getShopItems = (start: number, stop: number) => {
    const url = new URL(
      `https://ctfmarket.ru:8080/api/v1/product/${start}/${stop}`
    );
    ...
    <>
      ...
      <main>
        <div id="MovingImgWrapper">
          <div id="TopLogoText">
            <span>
              <p>CTF</p>
              <img
                src="/static/assets/images/marketNeonText.svg"
                alt="MARKET"
              />
              <p>CTF</p>
              <img
          ...
          <div id="BottomLogoText">
            <p>
              ЛЕТНЯЯ ШКОЛА CTF 2023 ЛЕТНЯЯ ШКОЛА CTF 2023 ЛЕТНЯЯ ШКОЛА CTF 2023
              ЛЕТНЯЯ ШКОЛА CTF 2023 ЛЕТНЯЯ ШКОЛА CTF 2023 ЛЕТНЯЯ ШКОЛА CTF 2023
              ЛЕТНЯЯ ШКОЛА CTF 2023
            </p>
          </div>
        </div>

        <img
          src="/static/assets/images/SignInBackground.svg"
          alt="Задний фон"
          id="BgImage"
        />

        <img
          src="/static/assets/images/tagline.svg"
          alt="Привет! Мы - движение CTF, покупай фирменный мерч - оплачивай CTF-койнами"
          id="Tagline"
        />
        ...
        <span id="PopularShopItem_Text">
          ...
          <Link href="/shopItems" className="seeMoreItemsRoute">
            Смотреть всe
          </Link>
        </span>

        <div id="PopularShopItemsWrapper">
          <ShopItemCard shopItems={shopItems} initialShopItems={shopItems} />
        </div>

        <img
          src="/static/assets/images/bugBountyBanner.svg"
          alt="BugBounty"
          id="BugBounty"
        />
      </main>
